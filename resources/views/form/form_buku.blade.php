...
@section('content')
<form id="formBuku" class="form-horizontal" action="{{ url('buku/save') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="fFoto col-md-3">
            <div class="box">
                ...
                <div class="box-body">
                    @if($buku['cover'])
                        <img id="orang" src="{{ asset('img/'.$buku['cover']) }}" style="width:100%;border: 2px solid #ccc;">
                    @else
